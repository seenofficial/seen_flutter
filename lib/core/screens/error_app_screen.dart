                ...
                ButtonAppComponent(
                  ...
                  buttonContent: Center(
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.center,
                      children: [
                        SvgImageComponent(iconPath: AppAssets.backIcon, color: ColorManager.whiteColor),
                  ...
                  onTap: () {
                    Navigator.of(context, rootNavigator: true).popUntil(ModalRoute.withName(RoutersNames.layoutScreen));
                  },
                ),
              ],
            ),
