...
class GetInspectionAmountToBePaidUseCase {
  final BasePreviewPropertyRepository _basePreviewPropertyRepository ;

  GetInspectionAmountToBePaidUseCase(this._basePreviewPropertyRepository);

  Future<Either<Failure, String>> call(String propertyId ) =>
      _basePreviewPropertyRepository.getInspectionAmountToBePaid( propertyId);
}