...
class BottomButtons extends StatelessWidget {
  const BottomButtons({super.key , required this.currentPage, required this.pageController , required this.propertyId , this.updateAppointment = false, });
        ...
        children: [
          ButtonAppComponent(
            ...
            buttonContent: Center(
              child: Text(
                updateAppointment || currentPage == 0 ? 'إلغاء' : 'السابق',
